    ...
    <div class="relative z-10 mx-auto max-w-[1500px] px-6 py-20 lg:px-10">
        <div class="grid grid-cols-1 gap-16 md:grid-cols-2 lg:grid-cols-4 lg:gap-12">
            ...
            <div class="space-y-8">
                <a href="/" wire:navigate class="flex items-center gap-5 group inline-flex">
                    ...
                    <div class="flex flex-col border-l-2 border-white/30 pl-5 space-y-0.5 transition-colors group-hover:border-white/60">
                        <span class="text-2xl font-semibold">Sekolah Pelita</span>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    @foreach(['Beranda' => '/', 'Profil Sekolah' => '/profil', 'Fasilitas' => '/fasilitas', 'Admisi' => '/admisi'] as $label => $url)
                    <li>
            ...
            <div>
                <h4 class="mb-10 inline-block border-b-2 border-blue-400 pb-2 text-lg font-bold   text-white">Jenjang Sekolah</h4>
                @php
                    $listJenjang = [
                        ['slug' => '/taman-kanak-kanak', 'nama' => 'Taman-kanak-kanak'],
                        ['slug' => '/sekolah-dasar', 'nama' => 'Sekolah Dasar'],
                        ['slug' => '/sekolah-menengah-pertama', 'nama' => 'Sekolah Menengah Pertama'],
                        ['slug' => '/sekolah-menengah-atas', 'nama' => 'Sekolah Menengah Atas'],
                        ['slug' => '/sekolah-menengah-kejuruan', 'nama' => 'Sekolah Menengah Kejuruan'],
                ...
                <ul class="space-y-4">
                    ...
                    <li>
                        <a href="/jenjang{{ $jenjang['slug'] }}" wire:navigate class="group flex items-center gap-3 text-sm font-medium text-blue-100 transition-all duration-300 hover:translate-x-2 hover:text-white">
                            <span class="h-1.5 w-0 rounded-full bg-blue-400 transition-all duration-300 group-hover:w-4"></span>
                            <span>{{ $jenjang['nama'] }}</span>
                        </a>
                    </li>
                    @endforeach
                </ul>
        ...
        <div class="mt-20 border-t border-white/20 pt-8 text-lg text-blue-200/80">
            <p>© {{ date('Y') }} SEKOLAH PELITA. <span class="hidden sm:inline">All rights reserved.</span></p>
        </div>
    </div>
</footer>