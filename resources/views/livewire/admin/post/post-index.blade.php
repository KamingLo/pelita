<div>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
            ...
            <p class="text-gray-500 text-sm font-medium">Kelola berita, pengumuman, dan prestasi SMK Pelita.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-4 border-b border-gray-50 bg-gray-50/50 flex flex-col md:flex-row gap-4">
            <div class="relative flex-grow max-w-sm">
                ...
                <input wire:model.live="search" type="text" placeholder="Cari judul atau jenjang..." 
            ...
            <select wire:model.live="filterType" class="border-gray-200 rounded-xl text-sm focus:ring-blue-600 focus:border-blue-600 transition-all">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left whitespace-nowrap">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-6 py-4 text-xs font-bold text-gray-400 uppercase tracking-widest">Konten & Jenjang</th>
                        <th class="px-6 py-4 text-xs font-bold text-gray-400 uppercase tracking-widest text-center">Tipe</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-blue-50/30 transition-colors group">
                        <td class="px-6 py-4">
                            <div class="flex flex-col">
                                ...
                                <div class="flex items-center gap-2 mt-1">
                                    ...
                                    <span class="text-[10px] text-gray-400 font-medium tracking-tighter uppercase">
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            @endphp
                            <span class="px-3 py-1 text-[10px] font-black uppercase tracking-widest rounded-full {{ $typeStyles }}">
                                {{ $post->type }}
                            </span>
                        </td>
