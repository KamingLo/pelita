<x-layouts.app>
    <x-slot:title>Pendaftaran Sekolah Pelita | Tumbuh Aman & Berprestasi</x-slot:title>
    <x-slot:description>Informasi pendaftaran dan admisi Sekolah Pelita. Bergabunglah dalam ekosistem pendidikan yang inklusif, mandiri, dan berkarakter untuk masa depan gemilang.</x-slot:description>

    <x-ui.hero-banner
        img="image/assets/school.jpg"
        title="Admisi & Masa Depan"
        desc="Menyambut generasi pembelajar dalam lingkungan yang ramah, aman, dan siap membimbing setiap potensi anak hingga mencapai versi terbaiknya."
    />
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="text-center max-w-4xl mx-auto mb-24" data-aos="fade-up">
                <div class="text-center mb-6">
                    <span class="text-blue-600 text-md font-medium">Penerimaan Siswa Baru</span>
                </div>
                <h1 class="text-5xl md:text-7xl font-bold text-slate-900 tracking-tight mb-8">
                    Rancang Masa Depan <span class="text-blue-600">Bersama Kami.</span>
                </h1>
                <p class="text-slate-600 text-xl leading-relaxed font-light">
                    Memilih sekolah adalah langkah penting bagi tumbuh kembang anak. Di Sekolah Pelita, kami menyediakan lingukungan ramah anak yang memastikan setiap siswa didukung secara emosional sembari membangun kecerdasan akademis dan keterampilan masa depan.
                </p>
            </div>
            ...
            <div class="grid lg:grid-cols-12 gap-16 items-start">
                ...
                <div class="lg:col-span-8" data-aos="fade-right">
                    ...
                    @php
                        $steps = [
                            ['01', 'Konsultasi Minat & Potensi', 'Bincang santai dengan tim pendidik kami untuk memahami karakter unik anak dan menyelaraskannya dengan metode belajar kami.'],
                            ['02', 'Kelengkapan Berkas', 'Pengumpulan dokumen pendukung. Kami menghargai setiap latar belakang dan siap mendampingi proses administrasi Anda dengan mudah.'],
                            ['03', 'Eksplorasi & Dialog Ramah', 'Bukan ujian yang menegangkan, melainkan dialog hangat untuk mengenal potensi anak dan memastikan sekolah kami menjadi tempat tumbuh yang nyaman.'],
                            ['04', 'Konfirmasi Penerimaan', 'Hasil pemetaan kelas dan informasi administratif akan disampaikan secara personal melalui portal pendaftaran atau pesan resmi.'],
                            ['05', 'Masa Orientasi Ramah Anak', 'Pengenalan lingkungan sekolah yang edukatif dan menyenangkan, sepenuhnya bebas dari senioritas maupun perundungan.']
                        ];
                    @endphp

                    <div class="space-y-4">
                        @foreach($steps as $step)
                            <div class="group flex flex-col sm:flex-row gap-8 p-8 rounded-3xl hover:bg-slate-50 transition-all duration-500">
                                <div class="shrink-0">
                    ...
                    <div class="bg-blue-50 p-10 rounded-[2.5rem] relative overflow-hidden">
                        ...
                        <div class="relative">
                            ...
                            <p class="text-slate-600 mb-8 leading-relaxed">
                                Tim kami siap membantu Anda memberikan informasi mengenai beasiswa, fasilitas belajar, maupun rincian biaya pendidikan.
                            </p>
                            ...
                            <div class="space-y-4">
                                ...
                                <a href="#" class="flex items-center justify-center gap-3 w-full bg-white text-slate-900 py-5 rounded-2xl font-bold transition-all hover:bg-slate-50 border border-slate-100">
                                    ...
                                    Unduh Katalog Sekolah
                                </a>
                            </div>

                            <div class="mt-8 p-6 bg-white/50 rounded-2xl border border-white/80">
                                <p class="text-xs text-slate-500 text-center">
                                    "Setiap anak berhak mendapatkan pendidikan yang bermartabat, aman dari intimidasi, dan mendukung pertumbuhan karakternya."
                                </p>
                            </div>
                        </div>
                    </div>
