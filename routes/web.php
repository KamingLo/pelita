...
use App\Http\Controllers\Public\LevelController;
...
Route::get('/', function () {
    $posts = Post::latest()->take(6)->get(); // Menampilkan 5 postingan terbaru dengan pagination
    
    return view('public.welcome', compact('posts'));
});


Route::get('/jenjang/{level}', [LevelController::class, 'show'])->name('public.jenjang.show');
